...
final class ImageFeedUITests: XCTestCase {
    ...
    func testAuth() throws {
        ...
        loginTextField.tap()
        loginTextField.typeText("muravyeva.irina@proton.me") // TODO: очистить перед заливом
        webView.swipeUp()
        ...
        passwordTextField.typeText("dygrid-3zAzbu-dechaf") // TODO: очистить перед заливом
        webView.swipeUp()
